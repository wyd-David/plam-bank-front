...
export class Service {
   ...
   * @throws ApiError
   */
  public static doTradingUsingPost(reqVo?: vo): CancelablePromise<CommonResponse_boolean_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static updateUserInfoUsingGet(phone?: string): CancelablePromise<CommonResponse_boolean_> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static loginUsingPost(loginReqVo?: any): CancelablePromise<CommonResponse_vo_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/user/login',
      body: loginReqVo,
   ...
   * @throws ApiError
   */
  public static doRechargeUsingPost(reqVo?: any): CancelablePromise<CommonResponse_vo_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static doWithdrawUsingPost(reqVo?: any): CancelablePromise<CommonResponse_vo_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static registerUsingPost(loginReqVo?: any): CancelablePromise<CommonResponse_vo_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/user/register',
      body: loginReqVo,
   ...
   * @throws ApiError
   */
  public static updateUserInfoUsingPost(userVo?: vo): CancelablePromise<CommonResponse_vo_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
